...
(function() {
    ...
    const ANCHORS = {
        prime: 1.50, kalats: 0.60, malatz: 0.51, katz: -1.30, matz: -1.05
    };
    ...
    const TERM_MIN = 1, TERM_MAX = 30;
    const LTV_MIN = { first: 25, replacement: 30, investor: 50 };

    window.AppConfig = { SCENARIOS, TAMHEEL_PROFILES, ANCHORS, CREDIT_MATRIX, TERM_MIN, TERM_MAX, LTV_MIN };
})();
